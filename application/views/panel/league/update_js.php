...
<script>
    ...
    jQuery(document).ready(function(){
        ...
        $('#leagueForm').validate({
            ...
            messages: {
                'rank[]': {
                    regex: 'Please enter a valid rank.'
                }
            },           
               ...
               var formData = new FormData(form);
                $.ajax({
                    ...
                    success: function(result) {
                        if(result==0)
                        {
                            location.href = '<?php echo base_url(); ?>panel/league';
                        }
                        else if(result==1)
                        {
                            location.href = '<?php echo base_url(); ?>panel/league/update/<?php echo $league->id; ?>';
                        }
                        else if(result==2)
                        {
                            location.href = '<?php echo base_url(); ?>panel/league/update/<?php echo $league->id; ?>';
